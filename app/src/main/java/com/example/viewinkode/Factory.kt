...
import com.example.viewinkode.Factory.toDp
...
object Factory {
    fun createScreen(context: Context, item: Item): Fragment {
        ...
        createLayout(context, item, fragment.container as ScrollView)
        return fragment
    }

    private fun createLayout(context: Context, item: Item, container: ScrollView) {
